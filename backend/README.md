...
## Project Structure
    ...
    ├── hurricanejunior_gol_40770  # Django project configurations
...
1. Clone this repo and `cd hurricanejunior_gol_40770`
...
2. Clone this repo and `cd hurricanejunior_gol_40770`
